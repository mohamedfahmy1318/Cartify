...
class $AssetsLottieGen {
  ...
  /// File path: assets/lottie/cartify.json
  LottieGenImage get cartify =>
      const LottieGenImage('assets/lottie/cartify.json');
...
class $AssetsPngGen {
  ...
  /// File path: assets/png/baner1.png
  AssetGenImage get baner1 => const AssetGenImage('assets/png/baner1.png');

  /// File path: assets/png/baner2.png
  AssetGenImage get baner2 => const AssetGenImage('assets/png/baner2.png');

  /// File path: assets/png/baner3.png
  AssetGenImage get baner3 => const AssetGenImage('assets/png/baner3.png');

  /// List of all assets
  List<AssetGenImage> get values => [baner1, baner2, baner3];
}
