...
import 'package:full_ecommerce_app/src/core/extensions/context_extension.dart';
import 'package:full_ecommerce_app/src/core/extensions/padding_extension.dart';
...
class DefaultDropDownField<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        if (label != null) AppText(label!, fontSize: 14),
        5.szH,
        Theme(
