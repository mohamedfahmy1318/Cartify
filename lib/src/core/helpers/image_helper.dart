      ...
      builder: (BuildContext context) => CupertinoActionSheet(
        ...
        actions: <Widget>[
          CupertinoActionSheetAction(
            child: AppText(LocaleKeys.camera, color: Colors.black),
            onPressed: () async {
          ...
          CupertinoActionSheetAction(
            child: AppText(LocaleKeys.photoLibrary, color: Colors.black),
            onPressed: () async {
        ...
        cancelButton: CupertinoActionSheetAction(
          onPressed: Go.back,
          child: AppText(LocaleKeys.cancel, color: Colors.black),
        ),
      ),
    );
  }
    ...
    final value = await showMenu<String?>(
      ...
      items: [
        PopupMenuItem(
          value: 'camera',
          child: ListTile(
            leading: AppAssets.svg.camera.svg(height: 24.h, width: 24.w),
        ...
        PopupMenuItem(
          value: 'photo_library',
          child: ListTile(
            leading: AppAssets.svg.uploadImage.svg(height: 22.h, width: 22.w),
            visualDensity: VisualDensity.compact,
