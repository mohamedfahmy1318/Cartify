...
class ProductsBannerModel extends ProductsBannerEntity {
  ...
  factory ProductsBannerModel.fromJson(Map<String, dynamic> json) {
    return ProductsBannerModel(
  ...
  factory ProductsBannerModel.fromEntity(ProductsBannerEntity entity) {
    return ProductsBannerModel(
      sold: entity.sold,
